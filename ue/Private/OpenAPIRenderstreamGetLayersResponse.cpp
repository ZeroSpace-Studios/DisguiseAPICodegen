...
void OpenAPIRenderstreamGetLayersResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIRenderstreamGetLayersResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
