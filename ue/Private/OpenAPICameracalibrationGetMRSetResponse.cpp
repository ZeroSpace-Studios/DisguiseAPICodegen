...
void OpenAPICameracalibrationGetMRSetResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICameracalibrationGetMRSetResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
