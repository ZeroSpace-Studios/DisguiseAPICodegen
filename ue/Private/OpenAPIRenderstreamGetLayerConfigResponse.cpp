...
void OpenAPIRenderstreamGetLayerConfigResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIRenderstreamGetLayerConfigResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
