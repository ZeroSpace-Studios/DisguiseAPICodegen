...
void OpenAPITransportGoToNextPrevInfo::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPITransportGoToNextPrevInfo::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
