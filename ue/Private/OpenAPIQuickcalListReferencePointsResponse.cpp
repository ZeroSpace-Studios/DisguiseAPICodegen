...
void OpenAPIQuickcalListReferencePointsResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIQuickcalListReferencePointsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
