...
void OpenAPISetIndirectionsRequestAssignment::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPISetIndirectionsRequestAssignment::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
