...
void OpenAPIV1EnableObservationResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIV1EnableObservationResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
