...
void OpenAPITransportListAnnotationsResult::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPITransportListAnnotationsResult::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
