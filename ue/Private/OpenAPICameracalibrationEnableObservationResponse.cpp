...
void OpenAPICameracalibrationEnableObservationResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICameracalibrationEnableObservationResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
