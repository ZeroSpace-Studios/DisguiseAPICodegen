...
void OpenAPIMixedrealityGetCamerasResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIMixedrealityGetCamerasResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
