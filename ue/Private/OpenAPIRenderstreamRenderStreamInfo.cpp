...
void OpenAPIRenderstreamRenderStreamInfo::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIRenderstreamRenderStreamInfo::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
