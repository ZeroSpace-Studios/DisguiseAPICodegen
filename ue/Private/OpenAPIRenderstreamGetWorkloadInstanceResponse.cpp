...
void OpenAPIRenderstreamGetWorkloadInstanceResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIRenderstreamGetWorkloadInstanceResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
