...
void OpenAPITransportListSetListsResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPITransportListSetListsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
