...
void OpenAPIMixedrealityListSpatialCalibrationsResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIMixedrealityListSpatialCalibrationsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
