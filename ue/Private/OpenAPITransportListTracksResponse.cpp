...
void OpenAPITransportListTracksResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPITransportListTracksResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
