...
void OpenAPIRenderstreamGetPoolsResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIRenderstreamGetPoolsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
