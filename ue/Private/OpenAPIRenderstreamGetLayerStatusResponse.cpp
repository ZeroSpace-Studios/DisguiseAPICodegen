...
void OpenAPIRenderstreamGetLayerStatusResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIRenderstreamGetLayerStatusResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
