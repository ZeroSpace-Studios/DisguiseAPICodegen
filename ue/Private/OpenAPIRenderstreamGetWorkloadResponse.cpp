...
void OpenAPIRenderstreamGetWorkloadResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIRenderstreamGetWorkloadResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
