...
void OpenAPITransportGetActiveTransportResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPITransportGetActiveTransportResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
