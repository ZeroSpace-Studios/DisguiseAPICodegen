...
void OpenAPITransportListAnnotationsResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPITransportListAnnotationsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
