...
void OpenAPIRenderstreamGetRenderMachineResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIRenderstreamGetRenderMachineResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
