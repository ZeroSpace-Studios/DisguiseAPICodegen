...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ColourApi()
        api_instance.colour_list_cdls  # this is an instance of the class Endpoint
        api_instance.colour_list_cdls()  # this invokes api_instance.colour_list_cdls.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.colour_list_cdls.callable or self.callable in this class
