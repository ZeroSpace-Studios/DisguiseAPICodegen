...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CameraCalibrationApi()
        api_instance.camera_calibration_add_observation  # this is an instance of the class Endpoint
        api_instance.camera_calibration_add_observation()  # this invokes api_instance.camera_calibration_add_observation.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.camera_calibration_add_observation.callable or self.callable in this class
