/*
 * renderstream_start_layers_request.h
 *
 * 
 */

#ifndef _renderstream_start_layers_request_H_
#define _renderstream_start_layers_request_H_
...
typedef struct renderstream_start_layers_request_t renderstream_start_layers_request_t;

#include "d3api_locator.h"



typedef struct renderstream_start_layers_request_t {
    list_t *layers; //nonprimitive container

} renderstream_start_layers_request_t;
...
#endif /* _renderstream_start_layers_request_H_ */
