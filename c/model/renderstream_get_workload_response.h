/*
 * renderstream_get_workload_response.h
 *
 * 
 */

#ifndef _renderstream_get_workload_response_H_
#define _renderstream_get_workload_response_H_
...
typedef struct renderstream_get_workload_response_t renderstream_get_workload_response_t;

#include "renderstream_workload_info.h"



typedef struct renderstream_get_workload_response_t {
    struct renderstream_workload_info_t *result; //model
...
#endif /* _renderstream_get_workload_response_H_ */
