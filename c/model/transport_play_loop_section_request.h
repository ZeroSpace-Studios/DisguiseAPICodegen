/*
 * transport_play_loop_section_request.h
 *
 * 
 */

#ifndef _transport_play_loop_section_request_H_
#define _transport_play_loop_section_request_H_
...
typedef struct transport_play_loop_section_request_t transport_play_loop_section_request_t;

#include "d3api_locator.h"



typedef struct transport_play_loop_section_request_t {
    list_t *transports; //nonprimitive container

} transport_play_loop_section_request_t;
...
#endif /* _transport_play_loop_section_request_H_ */
