/*
 * transport_go_to_frame_request.h
 *
 * 
 */

#ifndef _transport_go_to_frame_request_H_
#define _transport_go_to_frame_request_H_
...
typedef struct transport_go_to_frame_request_t transport_go_to_frame_request_t;

#include "transport_go_to_frame_info.h"



typedef struct transport_go_to_frame_request_t {
    list_t *transports; //nonprimitive container

} transport_go_to_frame_request_t;
...
#endif /* _transport_go_to_frame_request_H_ */
